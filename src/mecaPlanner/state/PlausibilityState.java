...
public class PlausibilityState implements java.io.Serializable {
    ...
    public PlausibilityState(List<String> agents, Set<World> worlds, Set<World> designated) {
    ...
    //public PlausibilityState(PlausibilityState toCopy) {
    ...
    public Set<World> getBelieved(String agent, World source) {
        return getMostPlausible(agent, source);
    }
...
//        }
    ...
    public PlausibilityState reduce() {
        //normalize();
        ...
        PlausibilityState reduced = new PlausibilityState(agents, newWorlds, newDesignated);
    ...
    private PlausibilityState union(PlausibilityState other) {
        assert (this != other);
        ...
        PlausibilityState unionPlausibilityState = new PlausibilityState(agents, unionWorlds, unionDesignated);

        for (String agent : agents) {
            for (World w : worlds) {
                unionPlausibilityState.setMorePlausible(agent, w, getMorePlausible(agent, w));
                unionPlausibilityState.setLessPlausible(agent, w, getLessPlausible(agent, w));
            }
            for (World w : other.getWorlds()) {
                unionPlausibilityState.setMorePlausible(agent, w, other.getMorePlausible(agent, w));
                unionPlausibilityState.setLessPlausible(agent, w, other.getLessPlausible(agent, w));
            }
        }
        return unionPlausibilityState;
    }
