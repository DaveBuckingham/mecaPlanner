...
Here is an example \emph{fluents} section:
\begin{verbatim}
fluents{
    at(robot1, room1),
    at(human1, room1),
...
and \emph{objects} example sections, the following example
\emph{fluents} section is equivalent to the previous example:
