...
knowledge.  The implementation of common knowledge is equivalent to ``everyone
knows that'', not infinite iteration of shared belief.
...
Each of \verb|f1,...,fn| is an action definition field\ldots
