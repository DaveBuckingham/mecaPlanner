...
public class EventModel {
    ...
    public PointedPlausibilityState transition(PointedPlausibilityState beforeState) {
        ...
        PointedPlausibilityState newState = new PointedPlausibilityState(agents, newWorlds, newDesignated.iterator().next());
